...
(5003, 'Bicicletta',        'MTB usata in buono stato',  'img/prova.jpg',      120.00, 1001,  'alice'), -- asta 1001 (aperta, senza offerte)
(5001, 'iPhone 13',         '128GB, ottime condizioni', 'img/prova.jpg',  350.00, 1002,  'alice'), -- asta 1002 (aperta, con offerte)
(5005, 'Console X',         'Edizione limitata',        'img/prova.jpg',  200.00, 1003,  'carol'), -- asta 1003 (chiusa con aggiudicatario)
...
(5004, 'Collezione monete', 'Serie completa 19xx',      'img/prova.jpg', 99999999.99,  NULL,  'carol'); -- prezzo al limite DECIMAL(10,2)
