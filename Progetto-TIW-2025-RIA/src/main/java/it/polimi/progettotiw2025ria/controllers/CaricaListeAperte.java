...
@WebServlet("/CaricaListeAperte")
public class CaricaListeAperte extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            List<Asta> asteAperte = astaDAO.getAsteAperteByUsername(utente.getUsername());

            JSONArray arrAste = new JSONArray();
            if (asteAperte != null) {
                for (Asta a : asteAperte) {
                    // arricchisco come fa la VendoServlet
                    ...
                    // costruisco JSON dell’asta
                    JSONObject jAsta = new JSONObject()
                            .put("id", a.getId())
                            .put("prezzoIniziale", a.getPrezzoIniziale())
                            .put("rialzoMinimo", a.getRialzoMinimo())
                            .put("scadenza", a.getScadenza().toString()) // ISO_LOCAL_DATE_TIME
                            .put("proprietario", a.getProprietario())
                            .put("tempoMancante", a.getTempoMancante());
